        ...
        >
          {[
            ...
            },
            {
              ...
              features: [
                "✅ 発見数: 1,000件/キャンペーン",
                "✅ Googleマップ・ Reddit・X・LinkedIn・Web全体",
                "✅ AIビジネスメール生成",
                "✅ 一括フォーム送信（1,000件/日）",
                "✅ クリック追跡・送信アナリティクス",
                "✅ キャンペーン数: 無制限",
        ...
        <div>
          {[
            ...
            },
            {
              ...
              a: "Freeプランから：Googleマップ・Reddit・X・アウトリーチメール自動送信は不可。Starter（29ドル/月）から：フォーム自動送信・アナリティクスが利用可能。Growth（99ドル/月）から：LinkedIn・Web全体クロール・クリック追跡・無制限キャンペーンで利用可能。",
            },
            {
              q: "半自動と全自動の違いは？",
